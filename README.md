...
2. Setup startup project 
  a) Set `PowerPointFolderViewerMVVM` as the startup project with MVVM Design pattern.
  b) Set `PowerPointFileEditorAddin` as the startup project without MVVM Design pattern.
